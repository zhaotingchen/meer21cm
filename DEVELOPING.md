...
- **Never let AI write unit tests**. The copilot/cursor AI autocomplete stuff is very useful, but one can easily become lazy and approve AI-generated changes that may be wrong. Avoid any autocomplete or AI-written code in unit test to make sure errors are caught.
